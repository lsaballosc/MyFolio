  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className=" w-[90vw] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-slate-700 p-5 md:p-16 md:w-[60vw] dark:border-zinc-700 dark:bg-[linear-gradient(90deg, rgba(4,7,29,1) 0%, rgba(12,14,35,1) 100%)]"
            key={idx}
          >
            <blockquote>
              <div
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  <div className="me-3">
                    <img src={item.img} alt="profile" /> {/* Imagen  */}
                  </div>
